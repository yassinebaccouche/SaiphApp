          ...
          children: [
            ...
            Center(
              child: GetBuilder<QuizController>(
                ...
                builder: (controller) => Container(width: MediaQuery.of(context).size.width,decoration:
                BoxDecoration(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: Theme.of(context).textTheme.headline3!.copyWith(color: Color(0xFF273085)
